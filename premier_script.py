...
def save_mean(y_train, prediction, run, nb_cc_value, ethnie, proportion, vectors_dict, l1_value, test_prop):
    cpt_correct = 0
    with open('/home/senantq/ORE/Analyses_stats/Codes/local_results/ID_results/resultsCauAf.csv', mode='a', newline='') as file:
...
ethnies = ['Caucasians', 'Afro_Americans']
ethnie_exclue = 'East_Asians'
...
nb_cc = [2]
run = 1
if not path.exists('/home/senantq/ORE/Analyses_stats/Codes/local_results/ID_results/resultsCauAf.csv'):
    with open('/home/senantq/ORE/Analyses_stats/Codes/local_results/ID_results/resultsCauAf.csv', mode='w', newline='') as file:
        writer = csv.writer(file)
